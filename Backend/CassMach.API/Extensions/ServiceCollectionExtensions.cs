...
namespace CassMach.API.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void AddResourcePermissionPolicies(AuthorizationOptions options)
        {
            ...
            var allPermissions = CassMach.Domain.Constants.Permissions.Helper.GetAllPermissions();
        ...
        private static void AddCombinedPermissionPolicies(AuthorizationOptions options)
        {
            ...
            var readWriteResources = new[] { "Users", "Roles", "Permissions", "Machines", "UserMachines" };
            ...
            var fullAccessResources = new[] { "Users", "Roles", "Permissions", "Machines", "UserMachines" };
