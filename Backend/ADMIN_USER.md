...
| Rol | Email | Şifre |
|-----|-------|-------|
| SuperAdmin | superadmin@cassmach.com | SuperAdmin123! |
| Admin | admin@cassmach.com | Admin123! |
| (standart) | user@cassmach.com | User123! |
...
Kullanıcılar ve ilgili veriler `CassMach.Infrastructure/Persistence/SeedData.cs` içinde tanımlıdır. Boş veritabanında uygulama başlarken seed çalışır; ayrıca eksik permission’lar için `SeedPermissionsAsync` her başlangıçta kontrol edilir.
